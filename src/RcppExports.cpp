...
RcppExport SEXP _tsbp_ncs(SEXP datSEXP, SEXP zSEXP, SEXP nsppSEXP, SEXP nlocSEXP, SEXP ngroupSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _tsbp_rmultinom1(SEXP probSEXP, SEXP randuSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _tsbp_getql(SEXP zSEXP, SEXP wSEXP, SEXP datSEXP, SEXP ngrlocSEXP, SEXP ngrsppSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type z(zSEXP);
...
RcppExport SEXP _tsbp_convertSBtoNormal(SEXP vSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_tsbp_ncs", (DL_FUNC) &_tsbp_ncs, 5},
    {"_tsbp_rmultinom1", (DL_FUNC) &_tsbp_rmultinom1, 2},
    {"_tsbp_getql", (DL_FUNC) &_tsbp_getql, 5},
    {"_tsbp_convertSBtoNormal", (DL_FUNC) &_tsbp_convertSBtoNormal, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_tsbp(DllInfo *dll) {
