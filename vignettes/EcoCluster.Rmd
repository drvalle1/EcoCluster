...
This vignette illustrates two different types of Bayesian clustering methods using truncated stick-breaking priors: mixture models and species archetype models (SAM). We apply these two clustering methods to simulated data to showcase how the number of groups can be successfully recovered.
